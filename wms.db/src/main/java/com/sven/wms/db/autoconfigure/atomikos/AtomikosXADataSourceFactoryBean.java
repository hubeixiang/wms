...
import com.sven.wms.db.autoconfigure.entity.DataSourceConfig;
...
public class AtomikosXADataSourceFactoryBean implements FactoryBean<AtomikosNonXADataSourceBean>, InitializingBean {
    ...
    private void initConnectionInfo(DataSourceConfig dataBaseConfig,
    ...
    private void initConnectionPoolConfig(DataSourceConfig dataBaseConfig,
