...
public class DateUtils2 {
	...
	private static Logger logger = LoggerFactory.getLogger(DateUtils2.class);
	...
	public static final String COMBINE_DATE_PATTERN = "yyyyMMdd";

	public static final String SHORT_DATETIME_PATTERN = "MM-dd HH:mm";
	public static final String SHORT_TIME_PATTERN = "HH:mm";

	/** Cache of chinese format. */
	private static PeriodFormatter cChinesePeriodFormatter;
	...
	public static PeriodFormatter chinesePeriodFormatter() {
		if (cChinesePeriodFormatter == null) {
			cChinesePeriodFormatter = new PeriodFormatterBuilder()
					.appendYears()
					.appendSuffix("年")
					.appendMonths()
					.appendSuffix("月")
		...
		return cChinesePeriodFormatter;
	}

	public static String formatPeriod(final Period period) {
		return period.normalizedStandard().toString(chinesePeriodFormatter());
	}
	...
	public static Timestamp toSqlDate(String dateTimeStr) throws Exception {
		Date date = DateUtils2.parseDate(dateTimeStr);
